...
import com.saldivar.pruebatecnica.helper.showDialogDelete
import com.saldivar.pruebatecnica.modulo.*
...
class DetalleTareaActivity : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            ...
            R.id.edit->{
                com.saldivar.pruebatecnica.helper.showDialog(dialog(), this)
            }
            R.id.delete->{
